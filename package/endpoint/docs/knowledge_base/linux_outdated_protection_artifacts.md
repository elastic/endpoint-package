...
Use this context when Elastic Defend on Linux reports a policy response failure or degraded policy application involving `download_global_artifacts`, including log messages such as:
