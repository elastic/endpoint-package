# Endpoint Process Group ID Change

- OS: Linux
- Data Stream: `logs-endpoint.events.process-*`
- KQL: `event.action : "gid_change" and event.dataset : "endpoint.events.process" and event.module : "endpoint" and host.os.type : "linux"`
