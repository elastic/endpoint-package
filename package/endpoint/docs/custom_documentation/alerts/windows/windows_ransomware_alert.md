...
| Ransomware.child_processes.executable | Absolute path to the process executable. |
| Ransomware.child_processes.files.data | File header or MBR bytes. |
| Ransomware.child_processes.files.entropy | Entropy of file contents. |
| Ransomware.child_processes.files.extension | File extension, excluding the leading dot. |
| Ransomware.child_processes.files.metrics | Suspicious ransomware behaviours associated with the file event. |
| Ransomware.child_processes.files.operation | Operation applied to file. |
| Ransomware.child_processes.files.path | Full path to the file, including the file name. |
| Ransomware.child_processes.files.score | Ransomware score for this particular file event. |
| Ransomware.child_processes.pid | Process id. |
| Ransomware.child_processes.score | Total ransomware score for aggregated file events. |
| Ransomware.feature | Ransomware feature which triggered the alert. |
| Ransomware.files.data | File header or MBR bytes. |
| Ransomware.files.entropy | Entropy of file contents. |
| Ransomware.files.extension | File extension, excluding the leading dot. |
| Ransomware.files.metrics | Suspicious ransomware behaviours associated with the file event. |
| Ransomware.files.operation | Operation applied to file. |
| Ransomware.files.path | Full path to the file, including the file name. |
| Ransomware.files.score | Ransomware score for this particular file event. |
| Ransomware.score | Total ransomware score for aggregated file events. |
| Ransomware.version | Ransomware artifact version. |
