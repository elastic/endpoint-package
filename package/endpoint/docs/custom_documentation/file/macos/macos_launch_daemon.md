...
| Persistence.args | Arguments used to execute the persistence item |
| Persistence.keepalive | Keep alive option boolean |
| Persistence.name | The persistence item's name |
| Persistence.path | The file's path |
| Persistence.runatload | Run at load option boolean |
