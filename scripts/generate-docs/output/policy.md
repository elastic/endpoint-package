...
| `policy.applied.response.configurations.ransomware.status` | the overall status of ransomware, this is correlated to the status of concerned actions  but not a simple sum of the actions | None |
