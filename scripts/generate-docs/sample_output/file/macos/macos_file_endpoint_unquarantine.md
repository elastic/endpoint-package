...
<tr><td><code>event.Ext.correlation.id<code></td><td>ID of event that this event is correlated to, e.g. quarantine event associated with an unquarantine event</td></tr>
