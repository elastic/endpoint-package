...
<ul>Original file extension prior to a modification event</ul>
...
<ul>Original file name prior to a modification event</ul>
...
<ul>Original file path prior to a modification event</ul>
