...
<ul>Array of file attributes.  Attributes names will vary by platform. Here's a non-exhaustive list of values that are expected in this field: archive, compressed, directory, encrypted, execute, hidden, read, readonly, system, write.</ul>

#### Example

<ul><code>["readonly", "system"]</code></ul>
...
<ul>Inode representing the file in the filesystem.</ul>

#### Example

<ul><code>256383</code></ul>
