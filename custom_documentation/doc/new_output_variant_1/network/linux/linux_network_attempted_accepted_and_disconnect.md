...
<td><code>event.dataset : "endpoint.events.network" and event.module : "endpoint" and host.os.type : "linux" and event.action : "connection_attempted" or "connection_accepted" or "disconnect_received"</code></td>
</tr>
</table>
