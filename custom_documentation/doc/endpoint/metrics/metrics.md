...
| Endpoint.metrics.queue_metrics.kernel.ebpf_ringbuf.lost |
...
| Endpoint.metrics.queue_metrics.user.events_queue.capacity |
| Endpoint.metrics.queue_metrics.user.events_queue.drops |
| Endpoint.metrics.queue_metrics.user.events_queue.size |
