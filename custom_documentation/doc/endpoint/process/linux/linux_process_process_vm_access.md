...
This event is generated when a process calls process_vm_readv(2) or process_vm_writev(2) to read from or write to another process's memory.
...
| process.Ext.process_vm_access.bytes_requested |
...
| process.Ext.process_vm_access.remote_addr |
