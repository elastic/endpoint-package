...
Flags passed to the memfd operation.
...
Filename for the created file. Appears in /proc/self/fd.
...
Sets the the close-on-exec flag on the new file descriptor.
...
Sets both NOEXEC and MFD_ALLOW_SEALING.
