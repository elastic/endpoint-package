...
<tr><td><code>process.Ext.api.metadata.background_callcount<code></td><td>This field indicates a number of all GetAsyncKeyState api calls, including unsuccessful calls, between the last successful GetAsyncKeyState call.</td></tr>
<tr><td><code>process.Ext.api.metadata.ms_since_last_keyevent<code></td><td>This field indicates the elapsed time in milliseconds since the last GetAsyncKeyState event.</td></tr>
<tr><td><code>process.Ext.api.metadata.procedure_symbol<code></td><td>Summary of the hook procedure.</td></tr>
<tr><td><code>process.Ext.api.metadata.return_value<code></td><td>Return value of RegisterRawInputDevices API call.</td></tr>
<tr><td><code>process.Ext.api.metadata.start_address_allocation_protection<code></td><td>Memory protection attributes associated with the starting address of a thread.</td></tr>
<tr><td><code>process.Ext.api.metadata.start_address_module<code></td><td>Name of the module associated with the starting address of a thread.</td></tr>
...
<tr><td><code>process.Ext.api.metadata.thread_info_flags<code></td><td>Thread info flags.</td></tr>
<tr><td><code>process.Ext.api.metadata.visible_windows_count<code></td><td>Number of visible windows owned by the caller thread.</td></tr>
<tr><td><code>process.Ext.api.metadata.windows_count<code></td><td>Number of windows owned by the caller thread.</td></tr>
...
<tr><td><code>process.Ext.api.parameters.flags<code></td><td>Mode flag that specifies how to interpret the information provided by UsagePage and Usage. Third member RAWINPUTDEVICE structure.</td></tr>
<tr><td><code>process.Ext.api.parameters.hook_module<code></td><td>DLL containing the hook procedure.</td></tr>
<tr><td><code>process.Ext.api.parameters.hook_type<code></td><td>Type of hook procedure to be installed.</td></tr>
...
<tr><td><code>process.Ext.api.parameters.usage<code></td><td>This parameter indicates the specific device (Usage) within the Usage Page. Second member RAWINPUTDEVICE structure.</td></tr>
<tr><td><code>process.Ext.api.parameters.usage_page<code></td><td>This parameter indicates the top-level collection (Usage Page) of the device. First member RAWINPUTDEVICE structure.</td></tr>
