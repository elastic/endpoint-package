...
<tr><td><code>process.Ext.memory_region.allocation_protection<code></td><td>Original memory protection requested when the memory was allocated. Example values include "RWX" and "R-X".</td></tr>
...
<tr><td><code>process.Ext.memory_region.region_start_bytes<code></td><td>First 64 bytes at the region base address.</td></tr>
<tr><td><code>process.Ext.memory_region.region_state<code></td><td>State of the memory region. Example values include "RESERVE", "COMMIT", and "FREE".</td></tr>
